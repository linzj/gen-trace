...
static void
myaction (int, siginfo_t *info, void *ucontext)
{
...
static bool
boardcastSignal (int num, int selfTid, int selfPid, int maxSendCount)
{
...
int
getUserContext (void **buf, int len)
{
